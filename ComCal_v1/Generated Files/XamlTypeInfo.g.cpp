...
#include "DayPage.g.hpp"
#include "MonthPage.g.hpp"
#include "App.g.hpp"
#include "WeekPage.g.hpp"
...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"ComCal_v1.DayPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::ComCal_v1::DayPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"ComCal_v1.MonthPage")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.Page"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::ComCal_v1::MonthPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"ComCal_v1.WeekPage")
    {
        ::XamlTypeInfo::InfoProvider::XamlUserType^ userType = ref new ::XamlTypeInfo::InfoProvider::XamlUserType(this, typeName, GetXamlTypeByName(L"Windows.UI.Xaml.Controls.Page"));
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::ComCal_v1::WeekPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }
