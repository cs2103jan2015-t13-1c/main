...
//Condition keywords string array, size and indexes int:
const int CONDITIONKEYWORDSARRAYSIZE = 3;
const std::string CONDITIONKEYWORDSARRAY[CONDITIONKEYWORDSARRAYSIZE] = { " and ", " or ", " -- " };
const int INDEX_AND = 0;
const int INDEX_OR = 1;
const int INDEX_EXCLUDE = 2;

//Search keywords string array, size and indexes int:
const int SEARCHKEYWORDSARRAYSIZE = 16;
const std::string SEARCHKEYWORDSARRAY[SEARCHKEYWORDSARRAYSIZE] = { " .d ", " and.d ", " or.d ", " --.d ", " .s ", " and.s ", " or.s ", " --.s ", " .e ", " and.e ", " or.e ", " --.e ", " .l ", " and.l ", " or.l ", " --.l " };
const int INDEX_SEARCHDESCRIPTION = 0;
const int INDEX_SEARCHANDDESCRIPTION = 1;
const int INDEX_SEARCHORDESCRIPTION = 2;
const int INDEX_SEARCHEXCLUDEDESCRIPTION = 3;
const int INDEX_SEARCHSTARTDATE = 4;
const int INDEX_SEARCHANDSTARTDATE = 5;
const int INDEX_SEARCHORSTARTDATE = 6;
const int INDEX_SEARCHEXCLUDESTARTDATE = 7;
const int INDEX_SEARCHENDDATE = 8;
const int INDEX_SEARCHANDENDDATE = 9;
const int INDEX_SEARCHORENDDATE = 10;
const int INDEX_SEARCHEXCLUDEENDDATE = 11;
const int INDEX_SEARCHLOCATION = 12;
const int INDEX_SEARCHANDLOCATION = 13;
const int INDEX_SEARCHORLOCATION = 14;
const int INDEX_SEARCHEXCLUDELOCATION = 15;
	...
	for (unsigned int i = 0; i < searchKeywordsAndParams.size(); i++) {
		for (unsigned int j = 0; j < searchKeywordsAndParams[i].size(); j++) {
			...
			if (i >= INDEX_SEARCHDESCRIPTION && i <= INDEX_SEARCHEXCLUDEDESCRIPTION) {
				...
				processCondition(i, INDEX_DESCRIPTION);
